...
def Num_2():
    if num2 >= num4 >= num3 >= num1:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num2}, {num4}, {num3}, {num1})")
    elif num2 >= num4 >= num1 >= num3:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num2}, {num4}, {num1}, {num3})")
    elif num2 >= num3 >= num4 >= num1:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num2}, {num3}, {num4}, {num1})")
    elif num2 >= num3 >= num1 >= num4:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num2}, {num3}, {num1}, {num4})")
    elif num2 >= num1 >= num4 >= num3:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num2}, {num1}, {num4}, {num3})")
    elif num2 >= num1 >= num3 >= num4:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num2}, {num1}, {num3}, {num4})")
def Num_3():
    if num3 >= num4 >= num2 >= num1:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num3}, {num4}, {num2}, {num1})")
    elif num3 >= num4 >= num1 >= num2:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num3}, {num4}, {num1}, {num2})")
    elif num3 >= num2 >= num4 >= num1:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num3 }, {num2}, {num4}, {num1})")
    elif num3 >= num2 >= num1 >= num4:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num3}, {num2}, {num1}, {num4})")
    elif num3 >= num1 >= num2 >= num4:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num3}, {num1}, {num2}, {num4})")
    elif num3 >= num1 >= num4 >= num2:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num3}, {num1}, {num4}, {num2})")
def Num_4():
    if num4 >= num3 >= num2 >= num1:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num4}, {num3}, {num2} {num1})")
    elif num4 >= num3 >= num1 >= num2:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num4}, {num3}, {num1}, {num2})")
    elif num4 >= num2 >= num3 >= num1:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num4}, {num2}, {num3}, {num1})")
    elif num4 >= num2 >= num1 >= num3:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num4}, {num2}, {num1}, {num3})")
    elif num4 >= num1 >= num2 >= num3:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num4}, {num1}, {num2}, {num3})")
    elif num4 >= num1 >= num3 >= num2:
        print(f"\033[34;4mHighest to Lowest\033[0m: ({num4}, {num1}, {num3}, {num2})")
